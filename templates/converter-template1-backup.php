	...
	<div id="tzc-layout1" class="tzc-layout1" data-number="<?php echo esc_html( $random_number ); ?>" style="<?php echo esc_attr( $layout_css ); ?>">
		...
		<table>
			<tbody>
				<tr class="tzc-row">
					...
					<td class="tzc-right">
						<div class="datetime-container">
							...
							</select><input type="text" placeholder="mm/dd/yy" class="tzc-date" id="tzc-date-<?php echo esc_attr( $random_number ); ?>" style="<?php echo esc_attr( $date_css ); ?>">
						</div>
					</td>
				</tr>
				...
				<tr class="tzc-row">
					<td></td>
					<td class="tzc-right tzc-message" id="tzc-message-<?php echo esc_attr( $random_number ); ?>" style="<?php echo esc_attr( $output_css ); ?>"></td>
				</tr>
